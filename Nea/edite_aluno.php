...
if(!isset($_POST['aluno'])){
  echo "Não foi selecionado nenhum aluno.";
}else{
  $idaluno = $_POST['aluno'];
}

$edtAluno = new TConnect();
$sqlAluno = "select * from aluno where idaluno = ".$idaluno." limit 1";
echo $sqlAluno;
$edtAluno->execQuery($sqlAluno);
$dados = $edtAluno->resultSet();
?>
...
<div id="templatemo_wrapper">
  ...
  <form method = "post" action ="atualizaluno.php" class="form-horizontal">
<fieldset>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="nome" name="nome" type="text" placeholder="Nome Completo" class="input-xxlarge" required="" value="<?php echo $dados['nome']; ?>">
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="endereco" name="endereco" type="text" placeholder="enderenço" class="input-xxlarge" required="" value="<?php echo "string"; $dados[''] ?>">
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="nasc" name="nasc" type="date" placeholder="" class="input-xlarge" required="" value="<?php echo $dados['nascimento']; ?>">    
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="nome_m" name="nome_m" type="text" placeholder="nome da mãe" class="input-xxlarge" required="" value="<?php echo $dados['nomemae']; ?>">
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="nome_p" name="nome_p" type="text" placeholder="nome do pai" class="input-xxlarge" value="<?php echo $dados['nomepai']; ?>">
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="idaluno" name="idaluno" type="hidden" value="<?php echo $idaluno; ?>">
    <button id="cadastrar" name="cadastrar" class="btn btn-primary">Atualizar</button>
  </div>
</div>
